...
import com.senla.store.util.InitBD;
...
public class ImitationTest {
    private static ImitationTest instance;
    private static final Logger LOGGER = Logger.getLogger(ImitationTest.class.getSimpleName());


    private ImitationTest() {
    ...
    public static ImitationTest getInstance() {
        return Objects.requireNonNullElse(instance, new ImitationTest());
    }
