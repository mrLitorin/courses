...
public class Builder {
    ...
    private Menu createBookSortingMenu() {
        ...
        bookSortingMenu.addMenuItem(
                new MenuItem("Sort books by title", SortAllBook.getInstance(1), bookSortingMenu),
                new MenuItem("Sort books by year", SortAllBook.getInstance(2), bookSortingMenu),
                new MenuItem("Sort books by price", SortAllBook.getInstance(3), bookSortingMenu),
                new MenuItem("Sort books by status", SortAllBook.getInstance(4), bookSortingMenu),
                new MenuItem("BACK to main menu", DoNothing.getInstance(), rootMenu));
